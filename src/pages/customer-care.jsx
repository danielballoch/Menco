...
const CustomerCare = () => (
  <Layout>
    ...
    <ContactSection>
        ...
        <form>
            <input type="text" name="HelpQuery" placeholder="*First Name" required/>
            <input type="text" name="HelpQuery" placeholder="Last Name"/>
            <input type="email" name="HelpQuery" placeholder="*Email" required/>
